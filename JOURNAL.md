...
Exercise database and filter (exercises.py) — local structured data store and a filter function that returns exercises matching a session type, experience level, and physical-limitation constraints.
...
Functions, parameters, return values, type hints
...
List/dict comprehensions for filtering and transformation
